...
#define AI_FLAG_NO_RESUPPLY (1<<8) //Will never attempt to actively resupply and will not be targetted by resupply-capable ships.

//Ship flags for special behavior
#define SHIP_SENSOR_CLOAK (1<<0) //Will not show up on the dradis
#define SHIP_AI_UNTARGETTABLE (1<<1) //Will not be targetted by AI ships
...
#define FLEET_NO_OCCUPATION (1<<1) //Does not occupy systems
//NSV13 change end
