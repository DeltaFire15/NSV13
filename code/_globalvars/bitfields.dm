...
DEFINE_BITFIELD(ai_flags, list(
	...
	"AI_FLAG_DESTROYER" = AI_FLAG_DESTROYER,
	"AI_FLAG_ANTI_FIGHTER" = AI_FLAG_ANTI_FIGHTER,
	"AI_FLAG_BOARDER" = AI_FLAG_BOARDER,
	"AI_FLAG_SWARMER" = AI_FLAG_SWARMER,
	"AI_FLAG_ELITE" = AI_FLAG_ELITE,
	"AI_FLAG_STATIONARY" = AI_FLAG_STATIONARY,
))

DEFINE_BITFIELD(required_ai_flags, list(
	"AI_FLAG_SUPPLY" = AI_FLAG_SUPPLY,
	"AI_FLAG_BATTLESHIP" = AI_FLAG_BATTLESHIP,
	"AI_FLAG_DESTROYER" = AI_FLAG_DESTROYER,
	"AI_FLAG_ANTI_FIGHTER" = AI_FLAG_ANTI_FIGHTER,
...
DEFINE_BITFIELD(affinity_flags, list(
	"AI_FLAG_SUPPLY" = AI_FLAG_SUPPLY,
	"AI_FLAG_BATTLESHIP" = AI_FLAG_BATTLESHIP,
	"AI_FLAG_DESTROYER" = AI_FLAG_DESTROYER,
	"AI_FLAG_ANTI_FIGHTER" = AI_FLAG_ANTI_FIGHTER,
...
DEFINE_BITFIELD(system_traits, list(
	"STARSYSTEM_NO_ANOMALIES" = STARSYSTEM_NO_ANOMALIES,
	"STARSYSTEM_NO_ASTEROIDS" = STARSYSTEM_NO_ASTEROIDS,
	"STARSYSTEM_NO_WORMHOLE" = STARSYSTEM_NO_WORMHOLE,
	"STARSYSTEM_END_ON_ENTER" = STARSYSTEM_END_ON_ENTER,
	"STARSYSTEM_BADLANDS_CLUSTER" = STARSYSTEM_BADLANDS_CLUSTER,
	"STARSYSTEM_NO_MISSIONS" = STARSYSTEM_NO_MISSIONS,
	"STARSYSTEM_FLEETS_AVOID" = STARSYSTEM_FLEETS_AVOID,
	"STARSYSTEM_UNDEFINED" = STARSYSTEM_UNDEFINED,
))
...
DEFINE_BITFIELD(overmap_deletion_traits, list(
	"DAMAGE_STARTS_COUNTDOWN" = DAMAGE_STARTS_COUNTDOWN,
	"DAMAGE_DELETES_UNOCCUPIED" = DAMAGE_DELETES_UNOCCUPIED,
...
DEFINE_BITFIELD(fleet_flags, list(
	"FLEET_NO_DICECOMBAT" = FLEET_NO_DICECOMBAT,
	"FLEET_NO_OCCUPATION" = FLEET_NO_OCCUPATION,
))

DEFINE_BITFIELD(ship_flags, list(
	"SHIP_SENSOR_CLOAK" = SHIP_SENSOR_CLOAK,
	"SHIP_AI_UNTARGETTABLE" = SHIP_AI_UNTARGETTABLE,
)) //NSV13 change end.
